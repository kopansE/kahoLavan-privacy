# מדיניות פרטיות — כחולבן (KahoLavan)

**תאריך עדכון אחרון:** 10 במרץ 2026

אפליקציית "כחולבן" (להלן: "האפליקציה") היא פלטפורמה לשיתוף מקומות חניה בין משתמשים בישראל. מדיניות פרטיות זו מתארת כיצד אנו אוספים, משתמשים, משתפים ומגנים על המידע האישי שלך.
